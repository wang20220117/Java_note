...
*用来定义数据库对象（数据库、表、字段）*
 ...
 ![img](.assets/f33446caa8c4418bab4bce1af0ca0827.png)
...
* 使用`DESC mytable; ` 查看表的结构：
 ...
 ![image-20240715110903414](.assets/image-20240715110903414.png)
...
常用命令：
 ...
 ![image-20240715164625733](.assets/image-20240715164625733.png)
...
## 数据库的列类型
 ...
 ![image-20240715160516076](.assets/image-20240715160516076.png)

 ![image-20240715160735000](.assets/image-20240715160735000.png)

 ![image-20240715161050614](.assets/image-20240715161050614.png)

 ![image-20240715161128542](.assets/image-20240715161128542.png)

## 数据库的字段属性（重点）

 ![image-20240715161750374](.assets/image-20240715161750374.png)

 ![image-20240715161811307](.assets/image-20240715161811307.png)
...
数据库引擎：
 ...
 ![image-20240715165850284](.assets/image-20240715165850284.png)



## 修改和删除数据表字段

 ![image-20240715170533215](.assets/image-20240715170533215.png)
...
>   * TRUNCATE 不会影响事务
>   *  ![image-20240716111301277](.assets/image-20240716111301277.png)
...
* 数据库中最核心的语句
 ...
 ![image-20240717155330575](.assets/image-20240717155330575.png)
...
```
 ...
 ![image-20240716144559207](.assets/image-20240716144559207.png)
...
模糊查询本质是 比较运算符
 ...
 ![image-20240716145424332](.assets/image-20240716145424332.png)
...
这条查询的结果是一个包含了订单编号、客户姓名和订单金额的表格，其中客户姓名来自于关联的 `customers` 表，通过 `customer_id` 来连接两个表。
 ...
 ![image-20240717153648125](.assets/image-20240717153648125.png)
...
以下主要是 MySQL 的函数。
 ...
 ![image-20240717161710739](.assets/image-20240717161710739.png)
...
处理类型为data的列！
 ...
 ![image-20240719110529848](.assets/image-20240719110529848.png)
...
示例：
 ...
 ![image-20240717163722414](.assets/image-20240717163722414.png)

## select小结

 ![image-20240717155330575](.assets/image-20240717155330575-173702202498150.png)
